...
# run ghostID
Trj=sol.y.T
ghostSeq, ctrlPlots = gid.ghostID(mod.sys_Farjami2021,g_Farjami,dt,Trj,peak_kwargs={"prominence":2,"width":1000},ctrlOutputs={"ctrl_qplot":True,"qplot_xscale":"linear","ctrl_evplot":True,"return_ctrl_figs":True}) #
