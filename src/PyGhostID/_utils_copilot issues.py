...
def sign_change(arr,OR_ws,OR_k):
    """
...
def parse_ghostid_kwargs(**kwargs):
    """Parse and validate kwargs for ghostID function.
    
    Returns a dictionary with all ghostID parameters and their validated values.
    """
    config = {}
    ...
    # track_ghost_branch specific parameter
